...
WEFITTER_API_URL = $MOBILE_FRONTEND_BASE_URL
WEFITTER_PUBLIC_ID = $MOBILE_FRONTEND_BASE_URL
WEFITTER_SECRET = $MOBILE_FRONTEND_BASE_URL
WEFITTER_TOKEN_DB_KEY = $MOBILE_FRONTEND_BASE_URL
WEFITTER_TOKEN_EXPIRE = $MOBILE_FRONTEND_BASE_URL
EOT
