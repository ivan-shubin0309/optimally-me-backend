module.exports = {
  up(queryInterface) {
    const createLibraryFiltersEthnicityTableSql = `
      CREATE TABLE IF NOT EXISTS libraryFiltersEthnicity (
    ...
    return queryInterface.sequelize.query(createLibraryFiltersEthnicityTableSql);
  },
  down(queryInterface) {
    return queryInterface.sequelize.query('DROP TABLE IF EXISTS libraryFiltersEthnicity;');
  }
};
