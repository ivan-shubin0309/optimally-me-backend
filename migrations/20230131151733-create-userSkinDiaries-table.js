...
module.exports = {
  up(queryInterface) {
    const createBiomarkerFiltersTableSql = `
      CREATE TABLE IF NOT EXISTS userSkinDiaries (
        id INTEGER AUTO_INCREMENT,
 
        userId INTEGER NOT NULL,

        feelingType TINYINT NULL,
        isWearingMakeUp BOOLEAN NOT NULL DEFAULT FALSE,
        notes TEXT(10000) NULL,
  ...
  down(queryInterface) {
    return queryInterface.sequelize.query('DROP TABLE IF EXISTS userSkinDiaries;');
  }
};
