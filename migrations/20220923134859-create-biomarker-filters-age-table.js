...
module.exports = {
  up(queryInterface) {
    const createBiomarkerFiltersAgeTableSql = `
      CREATE TABLE IF NOT EXISTS biomarkerFiltersAge (
    ...
    return queryInterface.sequelize.query(createBiomarkerFiltersAgeTableSql);
  },
  down(queryInterface) {
    return queryInterface.sequelize.query('DROP TABLE IF EXISTS biomarkerFiltersAge;');
  }
};
