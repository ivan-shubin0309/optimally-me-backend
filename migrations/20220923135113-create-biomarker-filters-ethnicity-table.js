...
module.exports = {
  up(queryInterface) {
    const createBiomarkerFiltersEthnicityTableSql = `
      CREATE TABLE IF NOT EXISTS biomarkerFiltersEthnicity (
    ...
    return queryInterface.sequelize.query(createBiomarkerFiltersEthnicityTableSql);
  },
  down(queryInterface) {
    return queryInterface.sequelize.query('DROP TABLE IF EXISTS biomarkerFiltersEthnicity;');
  }
};
