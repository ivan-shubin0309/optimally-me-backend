...
import { connectionSlugs } from '../../../common/src/resources/wefitter/non-wefitter-connection-slugs';
...
export class DeleteConnectionDto {
    @ApiProperty({ type: () => String, required: true, description: Object.values(connectionSlugs).join(', ') })
    @Type(() => String)
    @IsNotEmpty()
